...
st.markdown("<h1 style='text-align: center; color: #090979; font-size: 48px; text-decoration: underline dotted; font-family:droid-sans mono;'>Scan Squad</h1>", unsafe_allow_html=True)
