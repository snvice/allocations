...
st.markdown("<h1 style='text-align: center; color: #090979; font-size: 45px; text-decoration: underline dotted; font-family:MS Gothic;'>Scan Squad</h1>", unsafe_allow_html=True)
