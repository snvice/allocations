...
st.markdown("<h1 style='text-align: center; color: #090979; font-size: 45px; text-decoration: overline dotted; font-family:Gill Sans MT Ext Condensed Bold;'>Scan Squad</h1>", unsafe_allow_html=True)
...
lottie_url_hello = "https://assets4.lottiefiles.com/packages/lf20_7x45GFUqeu.json"
...
fig.update_layout(paper_bgcolor = "", font = {'color': "darkblue", 'family': "Arial"}, height=340, width=400)
